...
def declare_actions(
    ...
    torso_front_camera_floor_filter_node = "torso_front_floor_filter"
    torso_front_floor_filter_config = get_pal_configuration(
        pkg="pcl_ros",
        node=torso_front_camera_floor_filter_node,
    ...
    camera_components = LoadComposableNodes(
        ...
        composable_node_descriptions=[
            ...
            ComposableNode(
                ...
                name=torso_front_camera_floor_filter_node,
                namespace=LaunchConfiguration("namespace"),
                parameters=torso_front_floor_filter_config["parameters"],
                remappings=torso_front_floor_filter_config["remappings"],
            ),
        ],
    )
